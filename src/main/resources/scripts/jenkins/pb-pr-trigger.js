...
// var ce = require('@atlassian/clientside-extensions')

// ce.ButtonExtension.factory((extensionAPI, context) => {
//     return {
//         label: 'My Button',
//         onAction: () => {
...
(function() {
    ...
    require(['@atlassian/clientside-extensions-registry'], function(registry) {
        registry.registerPlugin('com.kylenicholls.stash.parameterized-builds:button-plugin-js', buttonPluginFactory);
    });
})();
...
//     require(['@atlassian/clientside-extensions-registry'], function(registry) {
//         registry.registerExtension('com.kylenicholls.stash.parameterizedbuilds:pr-trigger-jenkins', buttonPluginFactory);
//     });
