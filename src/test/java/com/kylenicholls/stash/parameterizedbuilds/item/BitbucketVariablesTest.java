...
public class BitbucketVariablesTest {
    ...
    private final String PR_USERNAME = "this_guy";
    ...
    public void setup() {
        ...
        when(user.getName()).thenReturn(PR_USERNAME);
    ...
    public void testAddBranch() {
        ...
        BitbucketVariables actual = new BitbucketVariables.Builder().add("$BRANCH", () -> branch)
                .build();
    ...
    @Test
    public void testPopulateFromPRSetsPRUsername() {
        BitbucketVariables actual = new BitbucketVariables.Builder()
                .populateFromPR(pullRequest, repository, projectKey, trigger, url).build();

        assertEquals(PR_USERNAME, actual.fetch("$PRUSERNAME"));
    }
    ...
    public void testPopulateFromPRSetsPRUrl() {
        ...
        String expected = url + "/projects/" + projectKey + "/repos/" + REPO_SLUG +
                "/pull-requests/" + PR_ID;
    ...
    public void testPopulateFromRefSetsBranch() {
        BitbucketVariables actual = new BitbucketVariables.Builder()
                .populateFromRef(SOURCE_BRANCH, refChange, repository, projectKey, trigger, url)
                .build();
    ...
    public void testPopulateFromStringsSetsBranch() {
        BitbucketVariables actual = new BitbucketVariables.Builder()
                .populateFromStrings(SOURCE_BRANCH, COMMIT, repository, projectKey, trigger, url)
                .build();
